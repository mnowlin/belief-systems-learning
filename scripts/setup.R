...
#project_folder <- "/Users/nowlinmc/Dropbox/01-IN PROGRESS/Research/insert/manuscript"

#file.copy("/Users/nowlinmc/Dropbox/Projects/Manuscript-files/template.qmd",
#          to=project_folder, copy.mode = TRUE)

#file.rename("/Users/nowlinmc/Dropbox/01-IN PROGRESS/Research/insert/manuscript/template.qmd", 
            "/Users/nowlinmc/Dropbox/01-IN PROGRESS/Research/insert/manuscript/insert.qmd")
